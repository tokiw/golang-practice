...
func Example_nearlyEqual() {
	//!+
	fmt.Println(Equal(1.0, 1.0))                  // "true"
	fmt.Println(Equal(1.0+1e-9, 1.0))             // "false"
	fmt.Println(Equal(1.0+1e-10, 1.0))            // "true"
	fmt.Println(Equal(1.0+1.0i+1e-10i, 1.0+1.0i)) // "true"
	fmt.Println(Equal(1.0+1.0i+1e-10, 1.0+1.0i))  // "true"
	//!-
